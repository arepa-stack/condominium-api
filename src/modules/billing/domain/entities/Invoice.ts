...
export interface InvoiceProps {
    ...
    paid_amount?: number;
    /**
     * For PETTY_CASH unit-level invoices generated by an assessment
     * batch, this points to the `petty_cash_assessment.id` that
     * spawned them. NULL for anything else (NORMAL invoices, manual
     * debt, etc.).
     */
...
export class Invoice {
    ...
    get assessment_id(): string | null | undefined { return this.props.assessment_id; }
